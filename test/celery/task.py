...
class Task(object):
    def __init__(self, task_name=None, flow_name=None, parent=None, node_args=None, retried_count=None):
    ...
    def delay(self, task_name, flow_name, parent, node_args, retried_count):
